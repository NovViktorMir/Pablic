...
func eer() {
	...
	fmt.Println("║.((╬X   X))                                                            ║")
	fmt.Println("║     ,-,                                                               ║")
	fmt.Println("║                    ВВЕЛИ НЕ КОРРЕКТНОЕ ВЫРАЖЕНИ                       ║")
	fmt.Println("╚═══════════════════════════════════════════════════════════════════════╝")
}
...
func hello() {
	fmt.Println("╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗")
	fmt.Println("║                                         ДОБРО ПОЖАЛОВАТЬ В КАЛЬКУЛЯТОР!                                                                   ( ^_^ )   version : 0.0016               ║")
	...
	fmt.Println("║ВНИМАНИЕ: режим AVTO: version : 0.0016 : работает только с Римскими и Арабскими выражениями.                                                                                        ║")
	fmt.Println("╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
}
